...
public class PrimGeneratorND implements MazeGeneratorND{
    private int dimension;

    public PrimGeneratorND(int dim) {
    ...
    public List<AnimationND> generateMaze(MazeND maze) {
        ...
        while(!remainingList.isEmpty()) {
            randInt = ThreadLocalRandom.current().nextInt(edgeList.size());
            nextEdge = edgeList.remove(randInt);
